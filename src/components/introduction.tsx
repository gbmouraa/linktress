...
import CardImage from "../assets/card-demonstration.png";
      ...
      <div className="max-w-7xl justify-center lg:flex lg:items-center">
        <div>
          <h1 className="text-center text-3xl font-extrabold text-white lg:text-left lg:text-5xl">
            Divulge seu{" "}
            <span className="bg-gradient-to-r from-violet-900 to-purple-400 bg-clip-text text-transparent">
              link na bio
            </span>{" "}
            em uma página exclusiva e personalizada
          </h1>
          <p className="mt-10 text-center text-zinc-200 lg:text-left lg:text-xl">

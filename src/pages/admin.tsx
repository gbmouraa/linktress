    ...
    <div>
      ...
      <div className="flex flex-col md:flex-row">
        ...
        <main className="mx-auto flex w-full max-w-[544px] flex-col gap-y-6 px-4 pt-8 md:max-w-[780px]">
          ...
          <div className="from-redGradient to-purpleGradient flex w-full flex-col items-center gap-y-4 rounded-xl bg-gradient-to-r px-4 py-10">
            <div className="mb-2">
              {profileImageURL !== null ? (
                <img
                  src={profileImageURL}
                  alt="Imagem de perfil"
                  className="h-10 w-10 rounded-full md:h-[70px] md:w-[70px]"
                />
              ) : (
